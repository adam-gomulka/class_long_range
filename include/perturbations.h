...
struct perturbations
{
  ...
  short has_source_delta_chi;  /**< do we need source for delta of interacting dark matter (long range)? */
  ...
  short has_source_theta_chi;  /**< do we need source for theta of interacting dark matter (long range)? */
  ...
  int index_tp_delta_chi; /**< index value for delta of idm (long range) */
  ...
  int index_tp_theta_chi;   /**< index value for theta of idm (long range) */
